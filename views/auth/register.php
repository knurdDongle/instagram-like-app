...
<div class="container col-md-5 text-center div-login">
	<div class="form-login">
		<form action="register/" method="post">
			<div class="margin-top: 30px;"><h1> Register in <span class="gramstain">Gramstain</span></h1></div>
			<div class="margin-top"><input type="text" class="login_text_input" name="username" placeholder="Username" required></div>
			<div class="margin-top"><input type="text" class="login_text_input" name="email" placeholder="Email" required></div>
			<div class="margin-top"><input type="password" class="login_text_input" name="password" placeholder="Password" required></div>
			<div class="margin-top"><input type="submit" class="form-control login_submit_input" name="register" value="Login"></div>
		</form>
	</div>
</div>
</body>
